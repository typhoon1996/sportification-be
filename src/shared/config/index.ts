...
if (fs.existsSync(envLocalPath)) {
  ...
  console.warn(`⚠️  No environment file found. Using process environment variables only.`);
}
...
const config: Config = {
  ...
  database: {
    uri: process.env.MONGODB_URI || 'mongodb://localhost:27017/sportification_dev',
    options: {
