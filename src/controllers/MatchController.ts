...
export class MatchController {
  ...
  static getMatches = asyncHandler(async (req: Request, res: Response) => {
    ...
    const sort = validateSort(req.query.sort as string) || { 'schedule.date': -1 };
  ...
  // Get match by ID
  static getMatchById = asyncHandler(async (req: Request, res: Response) => {
  ...
  // Join a match
  static joinMatch = asyncHandler(async (req: AuthRequest, res: Response) => {
    const match = await Match.findById(req.params.id);
  ...
  // Leave a match
  static leaveMatch = asyncHandler(async (req: AuthRequest, res: Response) => {
    const match = await Match.findById(req.params.id);
  ...
  // Update match score
  static updateScore = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  // Update match status
  static updateMatchStatus = asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const validTransitions: Record<MatchStatus, MatchStatus[]> = {
      [MatchStatus.UPCOMING]: [MatchStatus.ONGOING, MatchStatus.EXPIRED],
  ...
  // Delete match
  static deleteMatch = asyncHandler(async (req: AuthRequest, res: Response) => {
    const match = await Match.findById(req.params.id);
