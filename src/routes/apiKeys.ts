 ...
 *         description: Unauthorized
 */
router.delete('/:keyId', [param('keyId').isMongoId()], validateRequest, ApiKeyController.deleteApiKey);
 ...
 *         description: Unauthorized
 */
router.post('/:keyId/regenerate', [param('keyId').isMongoId()], validateRequest, ApiKeyController.regenerateApiKey);
