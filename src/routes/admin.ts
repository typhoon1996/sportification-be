 ...
 *         description: Forbidden - Admin access required
 */
router.get('/analytics/user-engagement', dateRangeValidation, validateRequest, AnalyticsController.getUserEngagementAnalytics);
 ...
 *         description: Forbidden - Admin access required
 */
router.get('/analytics/performance', dateRangeValidation, validateRequest, AnalyticsController.getPerformanceAnalytics);
 ...
 *         description: Forbidden - Admin access required
 */
router.get('/analytics/business-intelligence', dateRangeValidation, validateRequest, AnalyticsController.getBusinessIntelligence);
 ...
 *         description: Forbidden - Admin access required
 */
router.post('/analytics/reports/custom', customReportValidation, validateRequest, AnalyticsController.getCustomReports);
