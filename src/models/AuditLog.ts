...
const auditLogSchema = new Schema<IAuditLog>({
  ...
  action: {
    ...
    enum: [
      ...
      'login', 'logout', 'login_failed', 'account_locked', 'password_reset_requested',
      'password_reset_completed', 'password_changed', 'email_verified',
      
      // MFA actions
      'mfa_enabled', 'mfa_disabled', 'mfa_login_success', 'mfa_login_failed',
      ...
      // API key actions
      'api_key_created', 'api_key_used', 'api_key_regenerated', 'api_key_deleted',
      'api_key_rate_limited', 'api_key_expired',
      
      // Security actions
      'security_settings_updated', 'ip_restriction_violation', 'suspicious_activity',
      'data_export_requested', 'account_deleted',
      
      // Admin actions
      'user_impersonated', 'admin_action', 'permission_granted', 'permission_revoked'
    ]
  },
  resource: {
    type: String,
    ...
    index: true,
    enum: [
      'user', 'auth', 'mfa', 'oauth', 'api_key', 'security', 'admin',
      'match', 'tournament', 'venue', 'notification', 'chat'
    ]
  },
  resourceId: {
    type: String,
...
export const AuditLog = model<IAuditLog, Model<IAuditLog> & IAuditLogStatics>('AuditLog', auditLogSchema);