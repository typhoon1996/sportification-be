...
describe('TokenService', () => {
  ...
  describe('generateTokenPair', () => {
    ...
    it('should generate different tokens for different users', () => {
      const tokens1 = tokenService.generateTokenPair('user1', 'user1@example.com');
      const tokens2 = tokenService.generateTokenPair('user2', 'user2@example.com');
  ...
  describe('verifyAccessToken', () => {
    ...
    it('should throw error for tampered token', () => {
      const tokens = tokenService.generateTokenPair('user123', 'test@example.com');
