...
/**
 * VenuesEventSubscriber - Handles events from other modules
 *
 ...
 * - User events (for venue owner notifications)
 * - Match events (for venue availability management)
 * - Booking events (for payment processing, confirmations)
 *
 * @example
 * // To add a subscription:
 * // eventBus.subscribe('matches.match.created', this.handleMatchCreated);
 */
export class VenuesEventSubscriber {
  /**
  ...
  static initialize(): void {
    ...
    logger.info("VenuesEventSubscriber initialized");
  }
