...
/**
 * VenuesEventPublisher - Publishes domain events for venues module
 */
export class VenuesEventPublisher {
  private static readonly MODULE_NAME = "venues";
