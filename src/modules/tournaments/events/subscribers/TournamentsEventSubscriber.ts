...
/**
 * TournamentsEventSubscriber - Handles events from other modules
 *
 ...
 * - Match events (for tournament match results, bracket updates)
 * - Team events (for team registrations)
 * - User events (for participant notifications)
 *
 * @example
 * // To add a subscription:
 * // eventBus.subscribe('matches.match.completed', this.handleMatchCompleted);
 */
export class TournamentsEventSubscriber {
  /**
  ...
  static initialize(): void {
    ...
    logger.info("TournamentsEventSubscriber initialized");
  }
